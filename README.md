...
How to fit, transform, and visualize the first demixed principle component on the stimulus task parameter margin, the default ylim is c(-3, 3), user can change the y axis limit if it is not defaultly showing the compelet plots:
